...
Siden utvalget består av kun kvinner eller menn, kan vi hypoteseteste ut fra nullhypotesen om at det målte gjennomsnittet $\overline{x}$ er nærmere $\mu_w$ enn $\mu_m$. Vi har altså $H_0: \overline{x} < \frac{\mu_w + \mu_m}{2}$ og $H_A: \overline{x} \geq \frac{\mu_w + \mu_m}{2}$.
