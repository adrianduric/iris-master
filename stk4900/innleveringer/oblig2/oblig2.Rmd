...
- $\hat\beta_3$: Høyere verdi og fortsatt veldig signifikant for kvinner. Lavere verdi og signifikant på lavere konfidensnivå for menn.
- $\hat\beta_4$: Høyere verdi og signifikant på 90% konfidensnivå for menn. Lavere (negativ) verdi og fortsatt insignifikant for kvinner.
- $\hat\beta_5$: Fortsatt insignifikant for begge kjønn. Negativ verdi for kvinner.
- $\hat\beta_6$: Høyere verdi og signifikant på 90% konfidensnivå for kvinner. Lavere verdi og fortsatt insignifikant for menn.
- $\hat\beta_7$: Høyere verdi og fortsatt signifikant for menn. Lavere verdi og insignifikant for kvinner.
- $\hat\beta_8$: Så vidt høyere verdi for kvinner, lavere verdi for menn. Insignifikant for begge kjønn.